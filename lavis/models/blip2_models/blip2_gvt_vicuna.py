...
class Blip2GVTVicuna(Blip2VicunaInstruct):
    ...
    def load_from_pretrained(self, url_or_filename):
        ...
        # if os.path.exists("lavis/output/BLIP2_GVT/Pretrain_stage1_vicuna/20240421174/checkpoint_best.pth"):
        #     weights = torch.load("lavis/output/BLIP2_GVT/Pretrain_stage1_vicuna/20240421174/checkpoint_best.pth")
        #     self.load_state_dict(weights['model'], strict=False) 

        if os.path.exists("lavis/output/BLIP2_GVT/Pretrain_stage1/finetune_opt6.7b_coco/checkpoint_best.pth"):
            weights = torch.load("lavis/output/BLIP2_GVT/Pretrain_stage1/finetune_opt6.7b_coco/checkpoint_best.pth")
            self.load_state_dict(weights['model'], strict=False) 
